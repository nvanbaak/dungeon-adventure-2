...
class MyTestCase(unittest.TestCase):
    ...
    def test_heal_itself(self):
        mock_monster = MockMonster("monster1", "model", 1.0) # setting chance_to_heal as 1
        mock_monster.hp -= 60
    ...
    def test_heal_itself_with_full_hp(self):
        mock_monster = MockMonster("monster1", "model", 0.1)
    ...
    def test__set_min_heal_point(self):
        mock_monster = MockMonster("monster1", "model", 1.0)
